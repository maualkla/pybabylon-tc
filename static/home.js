...
if(document.getElementById('_signup_button')) document.getElementById('_signup_button').addEventListener('click', function (){_change_obj_color(document.getElementById('_signup_button'), "color_2_bg", "color_1_tx", "color_1_bg", "color_2_tx", "color_2_border"); window.location.replace("/signup");});